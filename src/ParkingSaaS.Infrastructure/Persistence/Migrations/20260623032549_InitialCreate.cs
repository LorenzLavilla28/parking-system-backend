        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ExitGraceMinutes = table.Column<int>(type: "integer", nullable: false),
                    AllowCashPayment = table.Column<bool>(type: "boolean", nullable: false),
                    PublicQrCodeUrl = table.Column<string>(type: "character varying(500)", maxLength: 500, nullable: true),
                    CreatedAt = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: false),
                    UpdatedAt = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_parking_locations", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_user_parking_locations", x => x.Id);
                    table.ForeignKey(
                        name: "FK_user_parking_locations_users_UserId",
                        column: x => x.UserId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_parking_locations_Slug",
                table: "parking_locations",
                column: "Slug",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_parking_locations_TenantId",
                table: "parking_locations",
                column: "TenantId");

            migrationBuilder.CreateIndex(
                name: "IX_parking_locations_TenantId_Status",
                table: "parking_locations",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_user_parking_locations_TenantId_ParkingLocationId",
